...
class ExperimentPlanner3D_v21_32GB(ExperimentPlanner3D_v21):
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(
            self.preprocessed_output_folder, "nnUNetPlansv2.1_verybig_plans_3D.pkl"
        )
    ...
    def get_properties_for_stage(
        ...
        # to be used
        ref = (
            Generic_UNet.use_this_for_batch_size_computation_3D * 32 / 8
        )  # 8 instead of 8.5 because YOLO
