...
class ExperimentPlanner3D_residual_v21_bfnnUNet_31(
    ExperimentPlanner3D_residual_v21_bfnnUNet
):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
...
class ExperimentPlanner3D_residual_v21_bfnnUNet_31_spRegnnU(
    ...
    def get_target_spacing(self):
        return np.array([2.0, 0.68825001, 0.68825001])
